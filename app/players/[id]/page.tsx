    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <section className="rounded-3xl bg-white p-6 shadow-card dark:bg-night-900 dark:shadow-card-dark">
        <div className="flex items-center gap-4">
          <span className="flex h-16 w-16 items-center justify-center rounded-full bg-pitch-700/10 font-display text-2xl font-extrabold text-pitch-700 dark:text-pitch-300">
            {player.shirtNumber ?? "·"}
          </span>
        ...
        {player.bio ? (
          <p className="mt-4 text-sm text-slate-600 dark:text-slate-300">{player.bio}</p>
        ) : (
          <p className="mt-4 text-sm text-slate-400">A short bio appears here from the official federation profile when available.</p>
        )}
      ...
      <section>
        <h2 className="mb-3 font-display text-lg font-bold">Tournament stats</h2>
